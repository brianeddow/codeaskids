				 ...
				 <div class="app-wrapper">
					...
					<div class="row welcome-introduction">
					 <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
					  <img src="../../src/media/blog-title.png" width="300" />
					  <p className="introduction-text">Below are a list of blogs related to coding, science, math and technology. We hope you enjoy and learn!</p>
					  </div>
					 </div>
					</WelcomeIntroduction>
