					...
					<IntroAndMission className="row">
						<Faq>
						 <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
							...
							<a href="#question-one" class="btn btn-info" data-toggle="collapse">When was this website created?</a>
							<div id="question-one" class="collapse">
								<p><strong>A:</strong> The website launched on XXXXX, XX, 2021.</p>
							</div>
                            <br/>
							<a href="#question-two" class="btn btn-info" data-toggle="collapse">How can I help?</a>
							<div id="question-two" class="collapse">
							...
							<br/>
							<a href="#question-three" class="btn btn-info" data-toggle="collapse">Why a monkey and the jungle theme?</a>
							<div id="question-three" class="collapse">
							...
							<br/>
							<a href="#question-four" class="btn btn-info" data-toggle="collapse">What if I’m older than the age range (3<sup>rd</sup> to 12<sup>th</sup> graders)?</a>
							<div id="question-four" class="collapse">
							...
							<br/>
							<a href="#question-five" class="btn btn-info" data-toggle="collapse">What's the Monkey’s Name?</a>
							<div id="question-five" class="collapse">
								<p><strong>A:</strong> Peels, make sure to wave hello when he appears on your screen with important or encouraging wordings.</p>
							</div>
							<br/>
							<a href="#question-six" class="btn btn-info" data-toggle="collapse">Is the Website Accessible and 508 Compliant?</a>
							<div id="question-six" class="collapse">
							...
							<br/>
							<a href="#question-seven" class="btn btn-info" data-toggle="collapse">Is the Website Accessible and 508 Compliant?</a>
							<div id="question-seven" class="collapse">
								<p><strong>A:</strong> We strive to meet these standards so all kids can get the most out of the knowledge we wish to share on our website. We are always open to suggestions on improving our accessibility or any special requests we will try to meet.</p>
							</div>
							<br/>
							<a href="#question-seven" class="btn btn-info" data-toggle="collapse">How can I volunteer?</a>
							<div id="question-seven" class="collapse">
								<p><strong>A:</strong> Please go to our contact page and click the "Volunteer" button.</p>
							</div>
							<br/>
							<a href="#question-seven" class="btn btn-info" data-toggle="collapse">Are there any rules for the website</a>
							<div id="question-seven" class="collapse">
