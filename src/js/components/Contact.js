				 ...
				 <div class="app-wrapper">
					...
					<div class="row welcome-introduction">
					 <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
						...
						Volunteers can contribute by writing articles, creating graphic designs and much more. Let us know how you’d like to contribute to helping kids and adults learn code the right way. All content will be reviewed by website administrators prior to posting.</p>
					  </div>
					 </div>
					</WelcomeIntroduction>
